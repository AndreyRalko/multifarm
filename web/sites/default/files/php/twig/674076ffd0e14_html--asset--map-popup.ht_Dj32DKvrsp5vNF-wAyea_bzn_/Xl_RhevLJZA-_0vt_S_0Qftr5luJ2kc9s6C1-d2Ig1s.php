...
class __TwigTemplate_6dbc83b7c7d517591d031587acda3328 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 17
        $context["body_classes"] = [((        // line 18
($context["logged_in"] ?? null)) ? ("user-logged-in") : ("")), (( !        // line 19
($context["root_path"] ?? null)) ? ("path-frontpage") : (("path-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["root_path"] ?? null), 19, $this->source))))), ((        // line 20
($context["node_type"] ?? null)) ? (("page-node-type-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["node_type"] ?? null), 20, $this->source)))) : ("")), ((        // line 21
...
<html";
  ...
  <body";
        // line 35
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [($context["body_classes"] ?? null)], "method", false, false, true, 35), 35, $this->source), "html", null, true);
        echo ">
    ";
        // line 36
...
";
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["logged_in", "root_path", "node_type", "db_offline", "html_attributes", "placeholder_token", "head_title", "attributes", "page"]);    }
    ...
    {
        return new Source("", "profiles/farm/modules/core/ui/theme/templates/html--asset--map-popup.html.twig", "D:\\OSPanel\\home\\multifarm2\\web\\profiles\\farm\\modules\\core\\ui\\theme\\templates\\html--asset--map-popup.html.twig");
    }
